...
import com.example.todolist2.viewmodel.ShowItemActivityViewModel;
...
public class ShowItemListActivity extends AppCompatActivity implements ItemsListAdapter.HandleItemsClick{
    ...
    private ShowItemActivityViewModel viewModel;
    ...
    private void initViewModel(){
        viewModel = new ViewModelProvider(this).get(ShowItemActivityViewModel.class);
